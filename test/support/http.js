...
function Request(app) {
    ...
    this.header = {};
    this.app = app;
    this.app.listen(0, function onListen() {
        self.addr = self.app.address();
        self.listening = true;
    });
}
...
Request.prototype.end = function (fn) {
    ...
    if (this.listening) {
        var req = http.request({
            method:this.method, port:this.addr.port, host:this.addr.address, path:this.path, headers:this.header
        });
