...
var defSettings = {
    search: ['session', 'query', 'params', 'body'],
...
_u.extend(Injector.prototype, {
    ...
    invoke: function invoke(obj, str, ctx, advice, cb) {
        ...
        try {
            ...
            if (cb)  ret.then(function invokeNoError(o) {
                //TODO - figure this out, why sometimes wrap sometimes not.
    ...
    _invokeInternal: function (p, str, ctx, advice, obj) {
        ...
        if (typeof obj === 'function') {
            return this.resolve(obj, null, ctx).then(function (res) {
                //let's handle a callback return;
                if (typeof res === 'function' && res.length) {
                    res.call(null, function (e, o) {
                        if (e) return bound(e);
                        bound(o);
                    })
                } else {
