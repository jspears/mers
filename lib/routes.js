...
module.exports = function MongooseRestRouter(base, router, options) {
    ...
    api.get(function (req, res, next) {
            var params = req.params, find, Model = req.Model, id = params.shift(), single = req.query.single;
            ...
            inject.invokeCB(function (e, o) {
                ...
                transform(o, _ctx).pipe(options.responseStream({
                    single: ('single' in req.query) ? req.query.single : single,
                    response: {total: _ctx.body.count}
                })).pipe(streams.ToJson()).pipe(streams.Stringify()).pipe(res);
            }, find, params, _ctx, get$advice);
    ...
    api.put(function (req, res, next) {
        ...
        inject.invokeCB(run(_ctx, res), Model.findOne(idObj(params.shift())), params, _ctx, put$advice);
    });
    ...
    function post$advice(str, ctx, obj, advice, nValue) {
        ...
        if (nValue && nValue.schema && typeof str[0] === 'string') {
        ...
        } else if (nValue && nValue._schema && nValue._schema.options && nValue._schema.options.type && nValue._schema.options.type[0] && typeof (ref = nValue._schema.options.type[0].ref) === 'string') {
    ...
    api.post(function (req, res, next) {
        ...
        inject.invokeCB(cb, Model, params, _ctx, post$advice);
